...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let peopleController = navController1.topViewController as! PeopleViewController
        peopleController.peopleStore = peopleStore
        
        let navController2 = tabBarController.viewControllers?[1] as! UINavigationController
        let searchViewController = navController2.topViewController as! SearchViewController
        searchViewController.peopleStore = peopleStore
        return true
    }
